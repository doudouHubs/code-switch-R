    ...
    >
      <form class="vendor-form" @submit.prevent="submitModal">
        ...
        <label class="form-field">
          ...
          <select v-model="modalState.form.modelCategory" :disabled="saving" class="mac-select">
            <option value="">{{ t('components.provider.modelCategory.options.auto') }}</option>
            <option value="chat">{{ t('components.provider.modelCategory.options.chat') }}</option>
            <option value="speech">{{ t('components.provider.modelCategory.options.speech') }}</option>
            <option value="embedding">{{ t('components.provider.modelCategory.options.embedding') }}</option>
            <option value="image">{{ t('components.provider.modelCategory.options.image') }}</option>
            <option value="video">{{ t('components.provider.modelCategory.options.video') }}</option>
          </select>
        </label>
...
const openPresetModal = (preset: BindingGeminiPreset) => {
  ...
  modalState.form.modelCategory = preset.modelCategory ?? ''
}
...
const openEditModal = (provider: BindingGeminiProvider) => {
  ...
  modalState.form.modelCategory = provider.modelCategory ?? ''
}
  ...
  try {
    if (modalState.presetMode) {
      ...
      await UpdateProvider({
        ...
        modelCategory: modalState.form.modelCategory || undefined,

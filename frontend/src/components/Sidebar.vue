  ...
  <nav class="mac-sidebar" :class="{ collapsed: isCollapsed }">
    ...
    <div class="nav-list">
      ...
      >
        ...
        <!-- Paw -->
        <svg v-else-if="item.icon === 'paw'" class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M8.5 17.5c.5-2.5 2-3.5 3.5-3.5s3 1 3.5 3.5c.5 2.5-1 4.5-3.5 4.5s-4-2-3.5-4.5Z"></path>
          <path d="M7 7.5a2 2 0 1 1-3.5 1.5A2 2 0 0 1 7 7.5Z"></path>
